...
class BellmanBasis:
    ...
    LOSSES = 'ls_bellman bellman model fullmodel reward covariance prediction \
    ...
    def covariance_calc(self):
        ...
        # call this full_covariance and make covariance like laplacian?
        # normalize columns?
    ...
    def laplacian_calc(self):
        ...
        return TT.dot(TT.dot(self.w_t.T, self.stack_bias(self.covc_t 
                - self.beta_ratio_t * self.lam_covc_t)), 
                self.w_t) + self.eta_t * self.bellman_calc()
